...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
      <div class="navbar navbar-expand-lg fixed-top navbar-dark bg-primary">
        <div class="container">
          <a href="../" class="navbar-brand">Bootswatch <i data-feather="circle"></i>
          </a>
...
<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
  Launch demo modal  <i data-feather="user" style="color:white"></i>
</button>
      ...
      <div class="modal-footer">
        ...
        <div id="source-modal" class="modal fade" tabindex='-1'>
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-header">
                <h4 class="modal-title">Source Code
                </h4>
          ...
          <form  class="needs-validation"  novalidate>
            <div id="articles"></div>
              <div class="form-row">
                  <div class="col-md-4 mb-3">
                    <label for="validationCustom01">First name</label>
                    <input type="number" step=any class="form-control" id="validationCustom01" placeholder="First name" value="Mark" required>
                    <div class="valid-feedback">
                      Looks good!
                    </div>
                  </div>
                ...
                <button type="button" name="add" id="add" class="btn btn-success">Add new</button> ||  <button class="btn btn-primary" type="submit">Submit form</button>
